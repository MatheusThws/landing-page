...
import profi from '../../../public/profi.jpg'
import Image from 'next/image'

export function Apresentacao() {
  return (
    <section id="apresentacao" className="py-20 px-5 bg-rose-200">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div>
          <h2 className="text-4xl font-semibold text-black mb-2">Sobre Nós</h2>
